            ...
            <div class="card border-0 shadow-lg rounded-5">
                <div class="row text-center p-4">
                    ...
                    while ($row = mysqli_fetch_assoc($sql)) {
                        ...
                        // Generate unique modal and link IDs
                        $modal_id = 'exampleModal' . $index;
                        $link_id = 'exampleModalLink' . $index;
                    ...
                    ?>
                        <div class="col-lg-3 col-md col-sm-6 col my-5 ">
                            ...
                            <div class="card shadow rounded-5 pt-5 border-0 h-100" style="width: 14rem; position: relative; background-color: <?php echo $color; ?>" data-bs-toggle="modal" data-bs-target="#<?php echo $modal_id; ?>">
                        ...
                        <div class="modal fade" id="<?php echo $modal_id; ?>" tabindex="-1" aria-labelledby="<?php echo $link_id; ?>" aria-hidden="true">
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <h1 class="modal-title fs-5" id="<?php echo $link_id; ?>"><?php echo $prg_name; ?></h1>
