                ...
                <form class="forms-sample" method="post" enctype="multipart/form-data">
                  ...
                  <div class="form-group">
                    ...
                    <div class="input-group mb-3">
                      <input type="file" class="custom-file-input form-control file-upload-info" id="inputGroupFile01"
                        name="glimg" onchange="displaySelectedFileName(this)" value="<?php echo $gl_img1; ?>" required>
...
?>
                  <div class="col mb-4">
                    <div class="card shadow h-100 d-flex flex-column">
                      <img src="../images/gallery/<?php echo $gall_img; ?>" class="card-img-top"
                        style="height: 200px; object-fit: cover; border-radius: 20px 20px 0px 0px" alt="...">
                      ...
                      <div class="mt-auto card-footer"> <!-- 'mt-auto' will push the button to the bottom -->
                        ...
                        <a href="admin-gallery.php?did=<?php echo $gall_id; ?>" class="btn btn-danger"><svg
