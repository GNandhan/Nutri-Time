...
if(isset($_POST['product_name'])) {
  ...
  $query = mysqli_query($conn, "SELECT pro_code, pro_price, pro_category, pro_subcat, pro_vp, pro_curquantity, pro_associate, pro_association FROM price WHERE pro_name = '$product_name'");
