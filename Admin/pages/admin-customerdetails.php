                ...
                ?>
                    <div class="row">
                        ...
                        <div class="col-lg-6 col-md col-sm col grid-margin stretch-card">
                            <div class="card">
                                <div class="card-body">
                                    <p class="card-description">Basic Details</p> <hr>
                                    <div class="row">
                        ...
                        <div class="col-lg-6 col-md col-sm col grid-margin stretch-card">
                            <div class="card">
                                <div class="card-body">
                                    <p class="card-description">Evaluation Records</p> <hr>
                                    <div class="row">
                                        <div class="col-lg col-md col-sm col">
                                            <ul>
                        ...
                        <div class="col-lg col-md col-sm col grid-margin stretch-card">
                            <div class="card">
                                <div class="card-body">
                                    <p class="card-description">Eating Habits</p> <hr>
                                    <div class="row">
                                        <div class="col-lg col-md col-sm col">
                                            <ul>
                        ...
                        <div class="col-lg-4 col-md col-sm col grid-margin stretch-card">
                            <div class="card">
                                <div class="card-body">
                                    <p class="card-description">Health Conditions</p> <hr>
                                            <ul>
                        ...
                        <div class="col-lg col-md col-sm col grid-margin stretch-card">
                            <div class="card">
                                <div class="card-body">
                                    <p class="card-description">Program Details</p> <hr>
                                            <ul>
                                                ...
                                                <li class="card-description"> Amount paid: <span style="font-weight:bolder; color:black;"><?php echo $cus_paid; ?></span></li>
