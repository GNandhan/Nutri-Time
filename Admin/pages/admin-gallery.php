                     ...
                     <div class="col mb-4">
                       <div class="card shadow h-100 d-flex flex-column">
                         ...
                         <div class="mt-auto card-footer"> <!-- 'mt-auto' will push the button to the bottom -->
                           ...
                           <a href="admin-gallery.php?did=<?php echo $gall_id; ?>" class="btn btn-danger" onclick="return confirmDelete();"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-trash" viewBox="0 0 16 16">
