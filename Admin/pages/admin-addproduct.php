                ...
                <div class="table-responsive">
                  <table class="table table-striped">
                    ...
                    ?>
                      <tbody>
                        <tr>
                          <td><a href="admin-addproduct.php?prid=<?php echo $pro_id; ?>" class="btn btn-inverse-secondary btn-icon-text p-2">Edit<i class="ti-pencil-alt btn-icon-append"></i></a></td>
                          <td><a href="admin-addproduct.php?prd_id=<?php echo $pro_id; ?>" class="btn btn-inverse-danger btn-icon-text p-2" onclick="return confirmDelete();">Delete<i class="ti-trash btn-icon-prepend"></i></a></td>
